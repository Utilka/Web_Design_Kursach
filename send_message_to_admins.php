    ...
    <div class="wrapper">
        ...
        <main class="main">
            ...
            <?php
                    ...
                    $result = mysqli_query($conn,  "INSERT INTO `messages_to_admins_no_show` (`id`, `sender_nick`, `sender_email`, `messages`, `datetime`) VALUES (NULL, '{$_POST['nickname']}', '{$_POST['email']}', '{$_POST['message']}', CURRENT_TIMESTAMP);");
